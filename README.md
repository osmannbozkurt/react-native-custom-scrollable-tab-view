...
## react-native-custom-scrollable-tab-view
[![npm version](https://badge.fury.io/js/react-native-custom-scrollable-tab-view.svg)](https://badge.fury.io/js/react-native-custom-scrollable-tab-view)
...
1. Run `npm install react-native-custom-scrollable-tab-view --save`
2. `var ScrollableTabView = require('react-native-custom-scrollable-tab-view');`
...
<a href="https://raw.githubusercontent.com/osmannbozkurt/react-native-custom-scrollable-tab-view/master/demo_images/demo.gif"><img src="https://raw.githubusercontent.com/osmannbozkurt/react-native-custom-scrollable-tab-view/master/demo_images/demo.gif" width="350"></a>
<a href="https://raw.githubusercontent.com/osmannbozkurt/react-native-custom-scrollable-tab-view/master/demo_images/demo-fb.gif"><img src="https://raw.githubusercontent.com/osmannbozkurt/react-native-custom-scrollable-tab-view/master/demo_images/demo-fb.gif" width="350"></a>

## Basic usage

```javascript
var ScrollableTabView = require('react-native-custom-scrollable-tab-view');
...
```
To start you can just copy [DefaultTabBar](https://github.com/skv-headless/react-native-custom-scrollable-tab-view/blob/master/DefaultTabBar.js).

## Examples

[SimpleExample](https://github.com/skv-headless/react-native-custom-scrollable-tab-view/blob/master/Example/SimpleExample.js).

[ScrollableTabsExample](https://github.com/skv-headless/react-native-custom-scrollable-tab-view/blob/master/Example/ScrollableTabsExample.js).

[OverlayExample](https://github.com/skv-headless/react-native-custom-scrollable-tab-view/blob/master/Example/OverlayExample.js).

[FacebookExample](https://github.com/skv-headless/react-native-custom-scrollable-tab-view/blob/master/Example/FacebookExample.js).
...
- **`page`** _(Integer)_ - set selected tab(can be buggy see  [#126](https://github.com/osmannbozkurt/react-native-custom-scrollable-tab-view/issues/126)
